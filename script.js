...
(function () {
  ...
  function closeMenu() {
    ...
    if (overlay) { overlay.style.display = 'none'; overlay.style.position = ''; }
  }
  burger.addEventListener('click', function () {
    ...
    if (open) {
      // Blocca scroll body senza jump (salva scrollY)
      ...
      if (overlay) { overlay.style.display = 'block'; overlay.style.position = 'fixed'; }
    } else {
  ...
  /* ================================================================
     PAUSA ANIMAZIONI QUANDO TAB NASCOSTA
     ================================================================ */
  document.addEventListener('visibilitychange', function() {
    var animated = document.querySelectorAll('.ticker-track, .wa-float, .hero__sun, .sunset__sun');
